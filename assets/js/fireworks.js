...
let spawnFireworks = null;

function stop_fireworks() {
	window.cancelAnimationFrame(start_fireworks);
	clearInterval(spawnFireworks);
}
...
function firework_loop() {
	...
	window.requestAnimationFrame(firework_loop);
}
